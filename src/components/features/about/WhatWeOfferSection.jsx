    ...
    <section className="bg-primary text-white py-16 mt-36 px-4">
      <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="absolute inset-0 flex justify-center items-center bg-black/30 rounded-lg group-hover:bg-black/40 transition-all duration-300">
              <div className="size-46 rounded-full mb-2 flex items-center justify-center transform group-hover:scale-110 transition-transform">
                <Link to='/brands'>
                  <button className="bg-background/60 ring heading-4 font-black uppercase rounded-full text-primary text-shadow px-4 py-4">
                    Expolre More
                  </button>
                </Link>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div>
            <p className="uppercase text-sm tracking-wide text-gray-200 mb-2 font-bold">
              Our Capability
            </p>
          ...
          <div className="text-gray-300 text-base leading-relaxed space-y-4">
            <p>
              At Keystone, we integrate advanced technologies and streamlined
              processes to deliver exceptional manufacturing outcomes. Our
              approach ensures precision, efficiency, and consistency across
              every stage of production.
            </p>
            <p>
              Whether you're scaling operations or launching new products, we
              provide agile, cost-effective, and globally competitive
