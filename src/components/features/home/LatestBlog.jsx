      ...
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-16">
          ...
          <div className="flex items-center space-x-4">
            <button className="flex items-center gap-2 text-sm font-semibold text-gray-600 uppercase cursor-pointer" id="prev-blog">
              <ArrowLeft size={16} /> Prev
            </button>
            <div className="w-12 h-px bg-gray-400"></div>
            <button className="flex items-center gap-2 text-sm font-semibold text-gray-600 uppercase cursor-pointer" id="next-blog">
    ...
    <Link to={`/blog/${slug}`}>
      <div className="bg-[var(--color-surface)] rounded-lg shadow-md overflow-hidden mb-1">
        ...
        <div className="p-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--color-dark)] mb-3 line-clamp-2 ">{title}</h3>
