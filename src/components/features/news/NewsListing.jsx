  ...
  return (
    <div className="bg-lite-dark text-white p-8">
      <div className="text-center mb-16">
        ...
        <h2 className="heading-1 text-secondary uppercase font-heading font-bold mb-8">
          Explore Our NEWS
        </h2>
        <p className="text-gray-700 text-base md:text-lg max-w-4xl mx-auto leading-relaxed">
          Discover the latest updates, industry insights, and innovations from
          Keystone. Stay informed about the trends shaping the future of
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        {newsPosts.slice(0, visibleCount).map((post) => (
          <div key={post.id} className="cursor-pointer border border-black rounded-lg  mb-5">
            <div className="flex flex-col md:flex-row items-center gap-8 bg-black/50 rounded-lg p-5">
              ...
              <div className="flex-1 space-y-4">
                <h2 className=" heading-2 font-bold text-white line-clamp-2">
                  {post.title}
                </h2>
                <p
                  className="prose prose-invert text-gray-300 text-lg leading-relaxed"
                ...
                <div className="flex md:justify-start justify-center">
                  <Link to={`/news/${post.slug}`} className="curser-pointer">
                    <button className="bg-secondary curser-pointer hover:bg-secondary/80 text-white font-semibold px-8 py-3 rounded-full transition-colors">
                      Read More
                    </button>
                  </Link>
                </div>
...
function DateDisplay({ dateString }) {
  ...
  return (
    <div className="flex-shrink-0">
      ...
      <div className="text-sm  font-medium border-b border-secondary pb-1">
        {month} {year}
      </div>
    </div>
  );
